...
Задание 2 – Увеличить ассортимент добавок к напиткам	+++
Дополнительное
Задание 3 – потоки данных (в теории можно было бы использовать в DeviceTester)
*/
#include "Beverages.h"
...
*/
	...
	{	
		auto beverage = 
			make_unique<CCoffee>()						// Наливаем кофе
			<< MakeCondiment<CCream>()					// Добавляем сливки
			<< MakeCondiment<CChocolateCrumbs>(2)		// Посыпаем шоколадной стружкой
			<< MakeCondiment<CCocolate>(5);			// Добавляем дольки шоколада
